...
- **Texto justificado con partición por sílabas** (`hyphens: auto`), última línea sin justificar. En móvil los bloques alternan izquierda y derecha para dar continuidad.
...
- 🟠 **El botón "Menú" mide 37 × 16 px**, cuando el mínimo son 44 × 44. Es la navegación principal en móvil para un público de 45-60 años.
- 🟠 **La tipografía se pide a Google** teniendo los ficheros en `scripts/fonts/`. Servirla en local quita la conexión de cada visitante a Google (exposición que la propia política de cookies reconoce) y acelera el primer pintado.

**2 · Verificación visual pendiente.** El navegador de Claude **no emite eventos de scroll ni avanza animaciones**, así que toda la coreografía se resolvió por geometría y medición del DOM. Falta que Alejandro confirme en pantalla: la casa anclada, el zoom de Sobre Atis, el carril y el barrido de la home móvil.
